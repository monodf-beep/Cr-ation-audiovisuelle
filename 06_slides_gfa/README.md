...
Treize slides 9:16 pour présenter le business case « club de l'Albanais » aux dirigeants du GFA Rumilly-Vallières (des chefs d'entreprise). Une idée par slide, texte ancré en bas, visuel plein cadre.
...
| Structure | 01 couverture · 02 la thèse · 03 le cycle de vie marketing · 04 le signal savoyard · 05 la chaîne sponsor · 06 Le Puy · 07 Wrexham · 08 la méthode · 09 qui je suis · 10 agrandir le gâteau · 11 le complexe · 12 un club piémontais · 13 clôture |
| Rupture | Les slides 09 à 12 forment un bloc clair, fond crème et texte navy, qui commence au portrait et porte la proposition. La clôture revient au sombre |
...
for(let i=0;i<13;i++){await p.evaluate(i=>phone.scrollTo({top:i*phone.clientHeight}),i);await p.waitForTimeout(400);await p.screenshot({path:'slide-'+String(i+1).padStart(2,'0')+'.png'});}
await b.close();})()"
```
